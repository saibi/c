...
typedef struct drill_shape {
	...
	int tilting; // 20160810 tilting type 
...
enum drill_tilting_type_idx {
	DRILL_SHAPE_TILTING_NONE = 0,
	DRILL_SHAPE_TILTING_8000,
	DRILL_SHAPE_TILTING_8000X_FLAT, 
	DRILL_SHAPE_TILTING_8000X_INCLINED, 

	DRILL_SHAPE_TILTING_INVALID,
};
