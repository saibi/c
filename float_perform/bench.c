...
const double a[8][3] = { {0.3870983098, 0, 0},
{0.7233298200, 0, 0},
{1.0000010178, 0, 0},
...
const double dlm[8][3] = { {252.25090552, 5381016286.88982, -1.92789},
...
const double e[8][3] = { {0.2056317526, 0.0002040653, -28349e-10},
...
const double pi[8][3] = { {77.45611904, 5719.11590, -4.83016},
...
const double dinc[8][3] = { {7.00498625, -214.25629, 0.28977},
...
const double omega[8][3] = { {48.33089304, -4515.21727, -31.79892},
...
const double kp[8][9] = { {69613.0, 75645.0, 88306.0, 59899.0, 15746.0, 71087.0, 142173.0, 3086.0, 0.0},
...
const double ca[8][9] = { {4.0, -13.0, 11.0, -9.0, -9.0, -3.0, -1.0, 4.0, 0.0},
...
const double sa[8][9] = { {-29.0, -1.0, 9.0, 6.0, -6.0, 5.0, 4.0, 0.0, 0.0},
...
const double kq[8][10] = { {3086.0, 15746.0, 69613.0, 59899.0, 75645.0, 88306.0, 12661.0, 2658.0, 0.0, 0.0},
...
const double cl[8][10] = { {21.0, -95.0, -157.0, 41.0, -5.0, 42.0, 23.0, 30.0, 0.0, 0.0},
...
const double sl[8][10] = { {-342.0, 136.0, -23.0, 62.0, 66.0, -52.0, -33.0, 17.0, 0.0, 0.0},
