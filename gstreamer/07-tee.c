...
int main(int argc, char *argv[])
{
	...
	g_object_set(visual, "shader", 0, "style", 2, NULL);


	/* link all elements taht can be automatically linked because they have "Always" pads */
	...
	/* release the request pads from the teee, and unref them */
